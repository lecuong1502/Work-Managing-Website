...
VALUES
("board_1", 1, 'Công việc nhóm', 'Các công việc cần hoàn thành theo nhóm.', 'linear-gradient(135deg, #667eea, #764ba2)', 'Workspace'),
("board_2", 1, 'Dự án React', 'Làm project web quản lý công việc bằng React.', 'linear-gradient(135deg, #fddb92, #d1fdff)', 'Workspace'),
("board_3", 2, 'Việc cá nhân', 'Danh sách việc riêng trong tuần.', '#722ed1', 'Workspace');
...
VALUES
('list_1', "board_1", 'To Do', 0),
('list_2', "board_1", 'In Progress', 1),
('list_3', "board_1", 'Done', 2),
('list_4', "board_2", 'To Do', 0);
